...
import AddConnectionModal from "./accounts/AddConnectionModal.js";
...
export default function Accounts() {
  ...
  const [addInitialSiteId, setAddInitialSiteId] = useState(0);
  const [addInitialPresetId, setAddInitialPresetId] = useState<string | null>(
    null,
  );
  ...
  const closeAddPanel = () => {
    setShowAdd(false);
    setAddInitialSiteId(0);
    setAddInitialPresetId(null);
  };
  ...
  useEffect(() => {
    ...
    setShowAdd(true);
    setAddInitialSiteId(requestedSiteId);
    setAddInitialPresetId(params.get("initPreset"));
    ...
    <div className="animate-fade-in">
      ...
      {activeSegment === "tokens" ? (
        ...
        <>
          <AddConnectionModal
            open={showAdd}
            activeSegment={activeSegment === "apikey" ? "apikey" : "session"}
            sites={sites}
            initialSiteId={addInitialSiteId}
            initialPresetId={addInitialPresetId}
